                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="text-center">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Get in touch with our team for expert advice, part identification,
                            or any questions about our agricultural spare parts.
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-gray-600">074 201 1033</p>
                                    <p className="text-sm text-gray-500">Available 8:00 AM - 6:00 PM</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-gray-600">qrmotors2006@gmail.com</p>
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-gray-600">+94 74 201 1033</p>
                                    <p className="text-sm text-gray-500">For quick responses and part photos</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={4}
                                    required
                                    placeholder="Please describe what you need help with or the part you're looking for..."
                            ...
                            <p className="text-sm text-gray-500 text-center">
                                By clicking send, your message will open in WhatsApp where you can review and send it to us.
                            </p>
                        </form>
                    </div>
                </div>
